...
from cafe_api.models import Categories, Items, OrderBasket, Order, PaidOrder, OrderArchive
from cafe_api.serializers import ItemsSerializer, CategoriesSerializer, OrderBasketSerializer, OrderSerializer, \
